      ...
      <div class="small-breadcrumb">
         <div class="container">
            <div class=" breadcrumb-link">
               <ul>
                  <li><a class="active" href="">ENCHERE TERMINE  </a></li>
                     ...
                     <div class="row">
                        ...
                        <div class="posts-masonry">
                           ...
                           <div class="col-md-4 col-sm-6 col-xs-12">
                              <div class="blog-post">
                                 <div class="post-img">
                                    <a href="#"> <img class="img-responsive" alt="" src="/imageProduit/{{$p->image}}" style="width: 500px ; height:300px"> </a>
                                 </div>
                                ...
                                <h3 class="post-title"> <a href="">{{$p->title}}</a> </h3>
                                   ...
                                   <p class="post-excerpt" style="color: orangered"> <strong>Prix Final: {{$p->new_price}} </strong> </p>
                                   <p class="post-excerpt" style="color: orangered" ><strong>Nom de Gagnant:  {{$p->winner}}</strong> </p>
